    ...
    <div class="form-card">
        ...
        <form action="process.php" method="POST" id="adoptionForm">
            ...
            <div class="form-grid">
                ...
                <div class="input-group">
                    <label for="duvod"><i class="fa-solid fa-heart-circle-check"></i> Důvod adopce</label>
                    <select id="duvod" name="duvod" required>
                        <option value="" disabled selected>Vyberte důvod...</option>
                        <option value="rodina">Hledám parťáka pro rodinu</option>
                        <option value="spolecnost">Chci společníka</option>
                        <option value="deti">Zvíře pro děti</option>
                        <option value="zachrana">Chci dát zvířeti nový domov</option>
                    </select>
                    <span class="error-msg">Vyberte důvod adopce</span>
                </div>
